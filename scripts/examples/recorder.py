...
Use rerun to visualize all robot outputs.
...
from light.utils.messages import KIN_ARRAY_MSG, JOINT_POS_TARGET_MSG, F32_ARRAY_MSG, INIT_MSG
...
class Recorder(object):
    ...
    def __init__(self, port=4344):
        ...
        replay_buffer_path = PTH.REC_PATH / CFG.RECORDING_EXP_NAME
            ...
            for event in self.node:
                ...
                if event["type"] == "INPUT":
                    if event['id'] == 'tick':
                        ...
                        self.on_array_input(
                            event,
                            KIN_ARRAY_MSG(CFG.CONTROL_NUM_JOINTS),
                        )
